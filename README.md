...
You can find the coordinates from Ciudad Juarez through the Wikipedia page of the city and then clicking on its geographic coordinates: [31°44′18.89″N 106°29′13.25″W](https://geohack.toolforge.org/geohack.php?language=es&pagename=Ciudad_Juárez&params=31.739444444444_N_-106.48694444444_E_type:city). This will take you to a GeoHack page where you can find the coordinates in decimal. You will need to do the same for all names you add to color_ordering.tsv. As mentioned above, do the same for 'Altamira Nuevo Leon', 'Altamira Tamaulipas' and 'Pabellon de Arteaga'.
